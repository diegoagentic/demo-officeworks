...
export default function DemoSidebar() {
    ...
    const c = isDarkSidebar ? {
        ...
        salesRepBadge: 'border-orange-800/50 bg-orange-900/30 text-orange-400',
        ...
        salesRepBadge: 'border-orange-200 bg-orange-50 text-orange-700',
